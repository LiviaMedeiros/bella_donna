define("underscore backbone backboneCommon ajaxControl command text!template/collection/DoppelCollection.html text!css/collection/DoppelCollection.css".split(" "), function(f, c, a, h, e, q, r)
{
  var k, p = c.Model.extend(),
    l, t = c.View.extend(
    {
      ...
      createDom: function()
      {
        ...
        g.prototype.template = f.template($("#DoppelPartsTemp").text());
        m.prototype.parentView = this;
        m.prototype.template = f.template($("#DoppelDetailTemp").text());
        var b = a.doc.createDocumentFragment();
        f.each(k.doppelList, function(d, c)
        {
      ...
      {
        b.preventDefault();
        a.isScrolled() || (e.startSe(1003), "true" === b.currentTarget.getAttribute("data-noLink") ? (b.currentTarget.setAttribute("data-noLink", ""), a.doc.querySelector("#doppelListWrap").className = "show", a.doc.querySelector("h1").className = "show", a.doc.querySelector("#doppelDetailWrap").className = "hide", n.remove()) : a.backLinkHandler())
      }
    }),
    g = c.View.extend(
    {
      ...
      doppelDetailShow: function(b)
      {
        ...
        {
          model: this.model
        }), a.doc.querySelector("#doppelDetailWrap").appendChild(n.render().el), e.getBaseData(a.getNativeObj()))
      }
    }),
    n, m = c.View.extend(
    {
  ...
  return {
    ...
    {
      e.changeBg("web_0010.jpg");
      e.startBgm("bgm02_anime07")
    },
    remove: function(a)
    {
      l && l.remove();
