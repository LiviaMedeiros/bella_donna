define("underscore backbone backboneCommon ajaxControl command text!template/chara/CharaComposeAttribute/ComposeAttributeBulkResult.html".split(" "), function(d, e, c, h, f, g)
{
  var b;
  return e.View.extend(
  {
    id: "composeAttributeBulkResult",
    className: "show",
    events: function()
    {
      var a = {};
