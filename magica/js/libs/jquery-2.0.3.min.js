...
(function(e, undefined)
{
  ...
  }, x.fn.init.prototype = x.fn, x.extend = x.fn.extend = function()
  {
    ...
    for ("boolean" == typeof s && (l = s, s = arguments[1] ||
      {}, a = 2), "object" == typeof s || x.isFunction(s) || (s = {}), u === a && (s = this, --a); u > a; a++)
      if (null != (e = arguments[a]))
        for (t in e) n = s[t], r = e[t], s !== r && (l && r && (x.isPlainObject(r) || (i = x.isArray(r))) ? (i ? (i = !1, o = n && x.isArray(n) ? n : []) : o = n && x.isPlainObject(n) ? n :
  ...
  x.event = {
    ...
    add: function(e, t, n, i, o)
    {
      ...
      if (y)
      {
        ...
        while (c--) u = X.exec(t[c]) || [], d = m = u[1], g = (u[2] || "").split(".").sort(), d && (f = x.event.special[d] ||
    ...
    remove: function(e, t, n, r, i)
    {
      ...
      if (m && (u = m.events))
      {
        ...
        while (l--)
          ...
          {
            p = x.event.special[h] ||
            {}, h = (r ? p.delegateType : p.bindType) || h, f = u[h] || [], a = a[2] && RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = f.length;
    ...
    trigger: function(t, n, r, i)
    {
        ...
        {}, i || !f.trigger || f.trigger.apply(r, n) !== !1))
      {
        ...
        {})[t.type] && q.get(a, "handle"), p && p.apply(a, n), p = c && a[c], p && x.acceptData(a) && p.apply && p.apply(a, n) === !1 && t.preventDefault();
    ...
    fix: function(e)
    {
      ...
      {}), r = a.props ? this.props.concat(a.props) : this.props, e = new x.Event(s), t = r.length;
