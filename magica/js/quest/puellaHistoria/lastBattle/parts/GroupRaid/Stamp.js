define("underscore backbone backboneCommon ajaxControl command text!template/quest/puellaHistoria/lastBattle/Stamp.html text!js/quest/puellaHistoria/lastBattle/json/stamp/list.json text!js/quest/puellaHistoria/lastBattle/json/stamp/commentList.json js/quest/puellaHistoria/lastBattle/Model".split(" "), function(f, p, d, r, x, y, z, A, B)
{
  var l, e, t, q, b = {},
    h = !1,
    g;
  r = p.View.extend(
  {
    ...
    tapStampBtn: function(a)
    {
      ...
      if (!d.isScrolled() && !t())
      {
        ...
        if (a = localStorage.getItem("puellaHistoriaLastBattleUsedStampList"))
        {
        ...
        var m = localStorage.getItem("puellaHistoriaLastBattleUsedComment"),
          c = JSON.parse(A);
  ...
  var C = p.View.extend(
    {
      ...
      tapSendBtn: function(a)
      {
        ...
        d.isScrolled() || h && b.stampId && b.comment && "0" != b.comment && B.sendStampInfo(
        {
          ...
          callback: function(a)
          {
            (a = localStorage.getItem("puellaHistoriaLastBattleUsedStampList")) ? b.stampId == a ? localStorage.setItem("puellaHistoriaLastBattleUsedStampList", b.stampId) : (-1 != a.indexOf(b.stampId) && (a = a.replace(b.stampId + ",", ""), a = a.replace("," + b.stampId, "")), localStorage.setItem("puellaHistoriaLastBattleUsedStampList", b.stampId + "," + a)): localStorage.setItem("puellaHistoriaLastBattleUsedStampList", b.stampId);
            localStorage.setItem("puellaHistoriaLastBattleUsedComment", b.comment);
            a = d.getDateShortening(
            {
              date: new Date
            });
            localStorage.setItem("puellaHistoriaLastBattleStampSendTime", a.yr + "/" + a.mo + "/" + a.da + " " + a.ho + ":" + a.mi + ":" + a.se);
            v(
            {})
          }
        })
    ...
    {
      a = a.currentTime;
      var b = localStorage.getItem("puellaHistoriaLastBattleStampSendTime");
      h = !1;
      b ? (b = d.getAddDate(
      {
        date: b,
