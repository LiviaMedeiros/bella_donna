define("underscore backbone backboneCommon ajaxControl command text!css/arena/ArenaResult.css js/event/arenaranking/view/EventArenaResultView".split(" "), function(h, k, a, d, e, f, g)
{
  var b, c;
  return {
    needModelIdObj: [
