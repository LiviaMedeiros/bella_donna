define("underscore backbone backboneCommon ajaxControl command text!template/event/EventWalpurgis/QuestResultMainBoss.html text!css/event/EventWalpurgis/QuestResultMainBoss.css js/event/EventWalpurgis/Utility".split(" "), function(h, m, a, k, c, n, p, q)
{
  var d, l = {},
    r = m.View.extend(
    {
      ...
      countDamageNum: function()
      {
        function b(b, f, e)
        {
          ...
          10 > g && (a.doc.getElementById("count").getElementsByClassName("damageNumImg")[f].dataset.num = g, a.doc.getElementById("count").getElementsByClassName("damageNumImg")[f].src = "/magica/resource/image_web/event/eventWalpurgis/result/_number/p_num_" + Number(g) + ".png")
        }
  ...
  return {
    ...
    init: function()
    {
      ...
      a.setStyle(p);
      c.changeBg("web_ev_1053_24012.ExportJson");
