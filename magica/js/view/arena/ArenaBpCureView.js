define("underscore backbone backboneCommon ajaxControl command text!template/arena/ArenaCurePop.html".split(" "), function(d, e, b, f, k, g)
{
  var c = !1,
    h = function()
    {
      return new(e.View.extend(
      {
        ...
        {
          a.preventDefault();
          b.isScrolled() || c || (c = !0, f.ajaxPost(b.linkList.useItem,
          {
            itemId: "CURE_BP",
            num: 1
          }, function(a)
  ...
  return {
    popupStart: function()
    {
      ...
      b.doc.getElementById("popupArea").getElementsByClassName("popupInner")[0].appendChild(a.render().el)
    }
  }
});
